...
- **Next:** Jorge tests v2 (desk first — mic checks in README's Sound-reactivity section — then projector with overlay + mic beside cerdo); then the asset-bank design conversation; then decide GitHub/PR graduation.
